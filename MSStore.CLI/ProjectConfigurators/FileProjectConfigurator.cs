...
namespace MSStore.CLI.ProjectConfigurators
{
    internal abstract class FileProjectConfigurator : IProjectConfigurator, IProjectPackager, IProjectPublisher
    {
        ...
        public virtual async Task<int> PublishAsync(string pathOrUrl, DevCenterApplication? app, DirectoryInfo? inputDirectory, bool noCommit, IStorePackagedAPI storePackagedAPI, CancellationToken ct)
        {
            ...
            return await storePackagedAPI.PublishAsync(app, GetFirstSubmissionDataAsync, AllowTargetFutureDeviceFamilies, output, packageFiles, noCommit, _browserLauncher, _consoleReader, _zipFileManager, _fileDownloader, _azureBlobManager, _environmentInformationService, _logger, ct);
        }
