...
namespace MSStore.CLI.ProjectConfigurators
{
    internal class ElectronProjectConfigurator : NodeBaseProjectConfigurator
    {
        ...
        public override async Task<int> PublishAsync(string pathOrUrl, DevCenterApplication? app, DirectoryInfo? inputDirectory, bool noCommit, IStorePackagedAPI storePackagedAPI, CancellationToken ct)
        {
            ...
            return await base.PublishAsync(pathOrUrl, app, inputDirectory, noCommit, storePackagedAPI, ct);
        }
    }
}