...
namespace MSStore.CLI.Commands.Flights.Submission.Rollout
{
    internal class FinalizeCommand : Command
    {
        ...
        public class Handler(ILogger<FinalizeCommand.Handler> logger, IStoreAPIFactory storeAPIFactory, IAnsiConsole ansiConsole, TelemetryClient telemetryClient) : AsynchronousCommandLineAction
        {
